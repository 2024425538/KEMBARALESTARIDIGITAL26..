# KEMBARALESTARIDIGITAL26..<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        * {
        ...
        @media (max-width: 992px) {
            ...
            .nav-links { 
                ...
                background: rgba(27, 94, 32, 0.98); backdrop-filter: blur(20px); 
...
<body>
        ...
        <div class="container">
            ...
            <div class="category-cards">
                ...
                <div class="category-card">
                    ...
                    <p>
                        <span class="en">Exclusively open to KV Besut Students (Certificate and Diploma).</span>
                        <span class="bm">Terbuka khas kepada pelajar peringkat Sijil dan Diploma dari KV Besut sahaja.</span>
                    </p>
                </div>
                <div class="category-card">
                    <div class="icon">
            ...
            <div class="timeline-container">
                <div class="timeline-item">
                    <div class="timeline-content">
                        <span class="date">30 April - 10 May 2026</span>
                        <h3>
                ...
                <div class="timeline-item">
                    <div class="timeline-content">
                        <span class="date">14 May 2026</span>
                        <h3>
        ...
        <div class="container">
            ...
            <div class="steps-container">
                ...
                <div class="step-card">
                    ...
                    <p>
                        <span class="en">Finalist announcement will be made on 14 May 2026</span>
                        <span class="bm">Pengumuman finalis akan dibuat pada 14 Mei 2026</span>
                    </p>
                </div>
                <div class="step-card">
    ...
    <section class="requirements" id="requirements">
        <div class="container">
            ...
            <div class="requirements-grid">
                <div class="requirement-card">
                    ...
                    <ul>
                        <li>
                            <i class="fas fa-check-circle"></i>
                            <span class="en">Must be a Certificate or Diploma student from KV Besut</span>
                            <span class="bm">Mestilah pelajar Sijil atau Diploma dari KV Besut sahaja</span>
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
                ...
                <div class="requirement-card">
                    ...
                    <ul>
                        ...
                        <li>
                            <i class="fas fa-check-circle"></i>
                            <span class="en">Video duration must be between 2 to 3 minutes</span>
                            <span class="bm">Durasi video mestilah antara 2 hingga 3 minit</span>
                        </li>
                        <li>
                            <i class="fas fa-check-circle"></i>
            ...
            <div style="text-align: center; margin-top: 50px; animation: fadeInUp 1s ease 0.6s both;">
                <a href="https://drive.google.com/drive/folders/1tvs2HfJfE6_ZjPuXmFKD-48dgBjTuPKT" target="_blank" class="btn btn-primary" style="background: linear-gradient(135deg, var(--primary-green), var(--secondary-green)); color: var(--white); box-shadow: 0 10px 30px rgba(27, 94, 32, 0.3);">
                    <i class="fas fa-external-link-alt" style="font-size: 1.2rem;"></i>
                    <span class="en">View Full Judging Rubric</span>
                    <span class="bm">Lihat Rubrik Penilaian Penuh</span>
                </a>
            </div>
...
pastu hilangkan tulisan Loading... dan logo daun tu, masa refresh website
